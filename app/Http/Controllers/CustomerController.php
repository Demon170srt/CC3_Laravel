...
class CustomerController extends Controller
{
    ...
    /**
     * Show customers who ordered the same products as Mateo Tillman.
     */
    public function sameProductsCustomers()
    {
        // Find the customer Mateo Tillman
        $customer =Customer::whereRaw("CONCAT(first_name, ' ', last_name) = ?", ['Mateo Tillman'])->first();
        if (!$customer) {
            return view('customers.same_products_customers', ['customers' => collect()]);
        }
        // Get product IDs ordered by Mateo Tillman
